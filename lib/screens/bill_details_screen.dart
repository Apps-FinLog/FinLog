...
class _BillDetailsScreenState extends State<BillDetailsScreen> {
  // No need for _billData here, it will be accessed via Provider

  @override
  void initState() {
    super.initState();
    // No parsing needed here, data is already in the shared BillData instance
  }
  ...
  void _konfirmasiBill() {
    ...
    debugPrint('Tombol Konfirmasi ditekan. Data: ${billData.billItems}, Total: ${billData.jumlahTotal}');
  ...
  Widget build(BuildContext context) {
    // No need for ChangeNotifierProvider.value here, it's provided higher up
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'FinLog',
